...
@section('title', 'Edit Agenda Desa')
@section('header', 'Edit Agenda Kegiatan')
...
<div class="form-shell">
    <div class="form-hero mb-4 d-flex flex-column flex-md-row justify-content-between gap-3 align-items-md-center">
        <div>
            ...
            <h3 class="fw-bold mb-2">Edit Kegiatan Desa</h3>
            <p class="mb-0 opacity-75">Perbarui informasi kegiatan desa yang sudah dibuat.</p>
        </div>
    ...
    <div class="row g-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('admin.agenda.update', $agenda->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="judul" id="inputJudul" class="form-control" value="{{ old('judul', $agenda->judul) }}" required placeholder="Contoh: Kerja Bakti Dusun Mawar">
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="date" name="tanggal" id="inputTanggal" class="form-control" value="{{ old('tanggal', $agenda->tanggal) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="time" name="jam" id="inputJam" class="form-control" value="{{ old('jam', $agenda->jam) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="penyelenggara" id="inputPenyelenggara" class="form-control" value="{{ old('penyelenggara', $agenda->penyelenggara) }}" required placeholder="Contoh: Karang Taruna">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="lokasi" id="inputLokasi" class="form-control" value="{{ old('lokasi', $agenda->lokasi) }}" required placeholder="Masukkan alamat atau nama tempat">
                            </div>
                        </div>

                        <div class="mb-4">
                            <label class="form-label">Deskripsi Kegiatan <span class="text-danger">*</span></label>
                            <textarea name="deskripsi" id="inputDeskripsi" class="form-control" rows="4" required placeholder="Jelaskan detail kegiatan, tujuan, dan apa yang perlu dibawa peserta...">{{ old('deskripsi', $agenda->deskripsi) }}</textarea>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <label class="upload-box d-block">
                                ...
                                <h5>Klik untuk mengubah gambar (Opsional)</h5>
                                <p class="text-muted mb-0 small">Biarkan kosong jika tidak ingin mengubah gambar.</p>
                        ...
                        <div class="d-flex flex-column flex-md-row gap-3 justify-content-start">
                            <button type="submit" class="btn btn-success rounded-pill px-5 fw-bold">
                                <i class="fa-solid fa-paper-plane me-2"></i> Perbarui Kegiatan
                            </button>
        ...
        <div class="col-lg-5">
            ...
            <div class="preview-card">
                <div class="preview-img" id="previewImg" style="background-image: url('{{ $agenda->gambar ? Storage::url($agenda->gambar) : 'https://images.unsplash.com/photo-1596422846543-75c6fc197f0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' }}');">
