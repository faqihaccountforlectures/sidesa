...
@section('header', 'Edit Warta Desa')
...
<div class="form-shell">
    <div class="form-hero mb-4 d-flex flex-column flex-md-row justify-content-between gap-3 align-items-md-center">
        <div>
            ...
            <h3 class="fw-bold mb-2">Edit Berita Desa</h3>
            <p class="mb-0 opacity-75">Perbarui informasi berita desa yang sudah dibuat.</p>
        </div>
    ...
    <div class="row g-4">
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="judul" id="inputJudul" class="form-control" value="{{ old('judul', $berita->judul) }}" required placeholder="Contoh: Peresmian Pasar Desa Digital">
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <select name="kategori" id="inputKategori" class="form-select" required>
                                        ...
                                        <option value="Inovasi" {{ old('kategori', $berita->kategori) == 'Inovasi' ? 'selected' : '' }}>Inovasi</option>
                                        <option value="Unggulan" {{ old('kategori', $berita->kategori) == 'Unggulan' ? 'selected' : '' }}>Unggulan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="date" name="tanggal" id="inputTanggal" class="form-control" value="{{ old('tanggal', $berita->tanggal) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="penulis" id="inputPenulis" class="form-control" value="{{ old('penulis', $berita->penulis) }}" required placeholder="Nama penulis berita">
                            </div>
                        </div>

                        <div class="mb-4">
                            <label class="form-label">Isi Berita <span class="text-danger">*</span></label>
                            <textarea name="konten" id="inputKonten" class="form-control" rows="6" required placeholder="Tuliskan detail berita atau pengumuman di sini...">{{ old('konten', $berita->konten) }}</textarea>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <label class="upload-box d-block">
                                ...
                                <h5>Ubah Gambar Berita (Opsional)</h5>
                                <p class="text-muted mb-0 small">Maks. 5MB (Kosongkan jika tidak diubah)</p>
                        ...
                        <div class="d-flex flex-column flex-md-row gap-3 justify-content-start">
                            <button type="submit" class="btn btn-success rounded-pill px-5 fw-bold">
                                <i class="fa-solid fa-paper-plane me-2"></i> Perbarui Berita
                            </button>
        ...
        <div class="col-lg-5">
            ...
            <div class="preview-card">
                <div class="preview-img" id="previewImg" style="background-image: url('{{ $berita->gambar ? Storage::url($berita->gambar) : 'https://images.unsplash.com/photo-1585829365295-ab7cd400c167?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' }}');">
                </div>
