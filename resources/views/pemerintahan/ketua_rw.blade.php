...
<div class="container py-5">
        ...
        <div class="col-12">
            <div class="card text-white bg-dark shadow" style="border-radius: 20px; overflow: hidden; border: none;">
                ...
                <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center text-center">
                    <h1 class="card-title fw-bold mb-0" style="font-size: 2.5rem;">Ketua RW</h1>
                    <p class="card-text fs-5 mt-2">Data Ketua RW Desa Medangasem</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <p class="card-text text-muted" style="line-height: 1.8;">
                                Bertugas mengoordinasikan seluruh RT di wilayahnya serta menjadi penghubung antara masyarakat dan pemerintah desa.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="alert alert-warning text-center rounded-3 mb-5">
        Belum ada data Ketua RW yang ditambahkan.
    </div>
    @endforelse
